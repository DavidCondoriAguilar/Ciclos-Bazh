...
export default function FirstSection() {
  return (
    <section className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4 w-[auto] h-[auto]">
      <article className="col-span-1 p-10 p-sm-5">
        <h1 className="first-section-h3">
        ...
        <div className="w-[auto] h-[auto] text-[18px] font-mulish font-[400] text-[#2b2326] tracking-[0.3px] py-[24px] ">
          ...
          <p className="py-[10px] ">En menos de lo que canta un Gallo</p>
        </div>
        <h2 className="text-[#2B2326] text-[24px] font-extrabold line-height-normal w-[auto] py-[28px] mt-[12px]">
